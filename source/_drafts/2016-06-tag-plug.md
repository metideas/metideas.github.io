...
> 本文转载自 [HaHack][1] 作者[wzpan](https://github.com/wzpan)
...
[1]:http://wzpan.github.io/hexo-theme-freemind/2014/03/16/tag-plugins/
...
> 文章作者：[Aphelou](http://www.metideas.com)
> 文章链接：<a href='{{ permalink }}' title='{{ title }}' >{{ permalink }}</a>
> 有问题或者建议欢迎在下方评论。欢迎转载、引用，但希望标明出处
